...
class rpi(gr.top_block):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.rpitx_rpitx_source_0 = rpitx.rpitx_source(samp_rate, f)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.rpitx_rpitx_source_0, 0))
    ...
    def set_f(self, f):
        self.f = f
        self.rpitx_rpitx_source_0.set_freq(self.f)
